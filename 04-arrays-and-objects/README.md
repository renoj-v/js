...
Suggested focus for this topic: Array/object methods (map, filter, reduce, destructuring, spread/rest), shallow vs deep copies.
...
index.html for 04-arrays-and-objects, following the same style as 01-03" if you want a
